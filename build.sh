...
case "$OS" in
    Linux*)
        ...
        ../Godot_v4.5.1-stable_mono_linux_x86_64/Godot_v4.5.1-stable_mono_linux.x86_64 --build-solutions --quit --headless --verbose
        rm -rf dist
        mkdir -p dist
    ...
    Darwin*)
        ...
        /Applications/Godot_mono.app/Contents/MacOS/Godot --build-solutions --quit --headless --verbose
        rm -rf dist
        mkdir -p dist
        cp ./.godot/mono/temp/bin/Debug/RouteSuggest.dll dist/
